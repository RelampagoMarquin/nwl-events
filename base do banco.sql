...
CREATE TABLE IF NOT EXISTS `db_events`.`tbl_event` (
  ...
  UNIQUE INDEX `pretty_name_UNIQUE` (`pretty_name` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 5
...
CREATE TABLE IF NOT EXISTS `db_events`.`tbl_subscription` (
  ...
  INDEX `fk_tbl_subscription_tbl_user_idx` (`subscribed_user_id` ASC),
  INDEX `fk_tbl_subscription_tbl_user1_idx` (`indication_user_id` ASC),
  INDEX `fk_tbl_subscription_tbl_event1_idx` (`event_id` ASC),
